...
@Component(
  selector: 'proficiencies-component',
  templateUrl: 'proficiencies_component.html',
  styleUrls: ['proficiencies_component.css'],
  directives: [
    routerDirectives,
...
class ProficienciesComponent implements OnInit, OnActivate, OnDestroy {
  ///
  /// bloc
  ///
  ///
  final bloc = DndProficienciesBloc();
  ...
  String goTo([int id]) => id != null
      ? RoutePaths.dndProficiency.toUrl(parameters: {idParam: '${id}'})
      : RoutePaths.dndProficiency.toUrl(parameters: {idParam: 'new'});
