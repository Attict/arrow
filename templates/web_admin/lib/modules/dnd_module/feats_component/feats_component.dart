...
@Component(
  ...
  templateUrl: 'feats_component.html',
  styleUrls: ['feats_component.css'],
  directives: [
    routerDirectives,
...
class FeatsComponent implements OnInit, OnActivate, OnDestroy {
  ///
  /// bloc
  ///
  ///
  final bloc = DndFeatsBloc();
  ...
  String goTo([int id]) => id != null
      ? RoutePaths.dndFeat.toUrl(parameters: {idParam: '${id}'})
      : RoutePaths.dndFeat.toUrl(parameters: {idParam: 'new'});
