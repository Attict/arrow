...
class ItemsComponent implements OnInit, OnActivate, OnDestroy {
  ///
  /// bloc
  ///
  ///
  final bloc = DndItemsBloc();
  ...
  String goTo([int id]) => id != null
      ? RoutePaths.dndItem.toUrl(parameters: {idParam: '${id}'})
      : RoutePaths.dndItem.toUrl(parameters: {idParam: 'new'});
