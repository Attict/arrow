...
@Component(
  selector: 'archetypes-component',
  templateUrl: 'archetypes_component.html',
  styleUrls: ['archetypes_component.css'],
  directives: [
    routerDirectives,
...
class ArchetypesComponent implements OnInit, OnActivate, OnDestroy {
  ///
  /// bloc
  ///
  ///
  final bloc = DndArchetypesBloc();
  ...
  String goTo([int id]) => id != null
      ? RoutePaths.dndArchetype.toUrl(parameters: {idParam: '${id}'})
      : RoutePaths.dndArchetype.toUrl(parameters: {idParam: 'new'});
