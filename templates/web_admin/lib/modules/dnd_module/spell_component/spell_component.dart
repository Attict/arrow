...
@Component(
  selector: 'spell-component',
  templateUrl: 'spell_component.html',
  styleUrls: ['spell_component.css'],
  directives: [
    formDirectives,
...
class SpellComponent implements OnInit, OnActivate, OnDestroy {
  final bloc = DndSpellBloc();
  ControlGroup form;
    ...
    switch (state) {
      ...
      case CoreState.saved:
        CoreApplication.instance.dialog = CoreDialog(
          title: 'Success',
          message: 'Your spell was successfully saved!',
  ...
  void _createForm() {
    form = FormBuilder.controlGroup({
      'name': Control<String>(bloc.spell.name, null),
      'desc': Control<String>(bloc.spell.desc, null),
      'range': Control<int>(bloc.spell.range, null),
    });
  }
}
