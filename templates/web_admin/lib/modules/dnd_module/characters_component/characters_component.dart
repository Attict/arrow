...
@Component(
  ...
  templateUrl: 'characters_component.html',
  styleUrls: ['characters_component.css'],
  directives: [
    routerDirectives,
...
class CharactersComponent implements OnInit, OnActivate, OnDestroy {
  ///
  /// bloc
  ///
  ///
  final bloc = DndCharactersBloc();
  ...
  String goTo([int id]) => id != null
      ? RoutePaths.dndCharacter.toUrl(parameters: {idParam: '${id}'})
      : RoutePaths.dndCharacter.toUrl(parameters: {idParam: 'new'});
