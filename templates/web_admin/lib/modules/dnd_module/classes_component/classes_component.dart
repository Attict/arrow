...
@Component(
  ...
  templateUrl: 'classes_component.html',
  styleUrls: ['classes_component.css'],
  directives: [
    routerDirectives,
...
class ClassesComponent implements OnInit, OnActivate, OnDestroy {
  ///
  /// bloc
  ///
  ///
  final bloc = DndClassesBloc();
  ...
  String goTo([int id]) => id != null
      ? RoutePaths.dndClass.toUrl(parameters: {idParam: '${id}'})
      : RoutePaths.dndClass.toUrl(parameters: {idParam: 'new'});
